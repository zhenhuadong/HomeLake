package com.zhenhua.homelake.xsd;
...
//         boolean isValid = validateXMLSchema(args[0],args[1]);
         boolean isValid = validateXMLSchema("src/main/java/com/zhenhua/homelake/xsd/Student.xsd", "src/main/java/com/zhenhua/homelake/xsd/Student.xml");
         if(isValid){
